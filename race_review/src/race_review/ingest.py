...
from .models import ChapterManifest, ImportRequest, SessionManifest
from .proxy import generate_proxy, generate_thumbnail
from .storage import atomic_json, write_parquet
from .telemetry import extract_chapters
...
class ImportService:
    ...
    def prepare(self, request: ImportRequest) -> SessionManifest:
        ...
        manifest = SessionManifest(
            ...
            processing_versions={
                ...
                "analysis": "1",
                "manifest": "1",
                "gopropy": "3040b2f4efc8624e24c0962289eabb25f6a26c7b",
            },
            processing_options={
    ...
    def _process(self, session_id: str, request: ImportRequest) -> SessionManifest:
        ...
        gps = filter_gps(gps, self.settings.gps_error_limit_m)
